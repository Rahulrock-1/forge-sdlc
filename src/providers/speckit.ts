...
export class SpecKitProvider extends BaseProvider {
  ...
  private generateSpecKitConstitution(context: ProviderExecutionContext): string {
    ...
    return `# Project Constitution & Engineering Principles (constitution.md)
...
3. **Deterministic Unidirectional Flow:** Presentation Layer $\rightarrow$ Application Services $\rightarrow$ Domain Model $\leftarrow$ Infrastructure Adapters. Zero circular dependencies.
