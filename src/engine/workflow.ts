...
export const DEFAULT_SDLC_WORKFLOW: WorkflowDefinition = {
  ...
  stages: [
    ...
    { id: 'architecture', capabilityId: 'forge.architecture', name: 'Architecture', description: 'Technical Architecture & C4 Design', requiredInputs: ['spec.md', 'constitution.md'], expectedOutputs: ['architecture.md'] },
    ...
    { id: 'tasks', capabilityId: 'forge.task-decomposition', name: 'Task Decomposition', description: 'Atomic Developer Tasks (tasks.md)', requiredInputs: ['plan.md', 'constitution.md'], expectedOutputs: ['tasks.md'] },
    { id: 'analyze', capabilityId: 'forge.analyze', name: 'Cross-Artifact Analysis', description: 'Consistency & Drift Audit', requiredInputs: ['spec.md', 'tasks.md', 'constitution.md'], expectedOutputs: ['analysis.md'] },
    { id: 'implement', capabilityId: 'forge.implement', name: 'Implementation', description: 'Autonomous Code Implementation', requiredInputs: ['tasks.md', 'constitution.md'], expectedOutputs: ['implementation.md'] },
    { id: 'test', capabilityId: 'forge.test', name: 'Testing', description: 'Automated Test Suite Synthesis', requiredInputs: ['constitution.md'], expectedOutputs: ['test-report.md'] },
    { id: 'review', capabilityId: 'forge.review', name: 'Multi-Lens Review', description: '5-Perspective Code & Architecture Review', requiredInputs: ['constitution.md'], expectedOutputs: ['review.md'] },
    { id: 'security', capabilityId: 'forge.security-review', name: 'Security Audit', description: 'OWASP & STRIDE Threat Verification', requiredInputs: ['constitution.md'], expectedOutputs: ['security-audit.md'] },
